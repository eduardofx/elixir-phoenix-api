defmodule AppWeb.Admin.ElectionController do
  use AppWeb, :controller

  alias App.{CreateElection, ElectionRepo, ListElections, UpdateElection}
  alias AppWeb.Guardian.Plug, as: GuardianPlug
